...
COURSES = [
    ...
    {"code":"BS 104", "name":"Electronics",                        "hours":3,"year":1,"term":1,"prereq":None,      "doctor_uid":"doctor_ahmed"},
    {"code":"CS 102", "name":"Computer Programming",               "hours":3,"year":1,"term":1,"prereq":None,      "doctor_uid":"doctor_sara"},
    {"code":"CS 101", "name":"Intro To Computer Science",          "hours":3,"year":1,"term":1,"prereq":None,      "doctor_uid":"doctor_omaima"},
    {"code":"IS 105", "name":"Intro To Information System",        "hours":3,"year":1,"term":1,"prereq":None,      "doctor_uid":"doctor_ahmed"},
    {"code":"BS 101", "name":"Calculus",                           "hours":3,"year":1,"term":1,"prereq":None,      "doctor_uid":"doctor_sara"},

    {"code":"H 203",  "name":"Technical Report Writing",           "hours":2,"year":1,"term":2,"prereq":"H 101",   "doctor_uid":"doctor_omaima"},
    {"code":"CS 104", "name":"Intro To Software Engineering",      "hours":3,"year":1,"term":2,"prereq":"CS 102",  "doctor_uid":"doctor_ahmed"},
    {"code":"BS 103", "name":"Probability and Statistics",         "hours":3,"year":1,"term":2,"prereq":"BS 101",  "doctor_uid":"doctor_sara"},
    {"code":"H 202",  "name":"Human Rights",                       "hours":2,"year":1,"term":2,"prereq":None,      "doctor_uid":"doctor_omaima"},
    {"code":"CS 103", "name":"Object-Oriented Programming",        "hours":3,"year":1,"term":2,"prereq":"CS 102",  "doctor_uid":"doctor_ahmed"},
    {"code":"H 103",  "name":"Creative Thinking and Communication","hours":2,"year":1,"term":2,"prereq":None,      "doctor_uid":"doctor_sara"},
    {"code":"BS 102", "name":"Discrete Mathematics",               "hours":3,"year":1,"term":2,"prereq":"BS 101",  "doctor_uid":"doctor_omaima"},

    # --- مقررات السنة الثانية ---
    {"code":"IS 207", "name":"Web Technology",                     "hours":3,"year":2,"term":3,"prereq":"CS 103",  "doctor_uid":"doctor_ahmed"},
    {"code":"IS 206", "name":"Intro To Database",                  "hours":3,"year":2,"term":3,"prereq":"IS 105",  "doctor_uid":"doctor_sara"},
    {"code":"CS 202", "name":"Computer Architecture",              "hours":3,"year":2,"term":3,"prereq":"BS 104",  "doctor_uid":"doctor_omaima"},
    {"code":"BS 202", "name":"Operations Research",                "hours":3,"year":2,"term":3,"prereq":"BS 101",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 201", "name":"Data Structures",                    "hours":3,"year":2,"term":3,"prereq":"CS 103",  "doctor_uid":"doctor_sara"},
    {"code":"BS 201", "name":"Linear Algebra",                     "hours":3,"year":2,"term":3,"prereq":"BS 101",  "doctor_uid":"doctor_omaima"},

    {"code":"CS 203", "name":"Algorithms Analysis and Design",     "hours":3,"year":2,"term":4,"prereq":"CS 201",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 204", "name":"Operating Systems",                  "hours":3,"year":2,"term":4,"prereq":"CS 202",  "doctor_uid":"doctor_sara"},
    {"code":"CS 205", "name":"Computer Networks Technology",       "hours":3,"year":2,"term":4,"prereq":"CS 202",  "doctor_uid":"doctor_omaima"},
    {"code":"CS 310", "name":"Selected Topics in Computer Science - Level 3","hours":3,"year":2,"term":4,"prereq":None,"doctor_uid":"doctor_ahmed"},
    {"code":"CS 413", "name":"Human Computer Interaction",         "hours":3,"year":2,"term":4,"prereq":None,      "doctor_uid":"doctor_sara"},
    ...
    {"code":"CS 301", "name":"Theory of Programming Languages",    "hours":3,"year":3,"term":5,"prereq":None,      "doctor_uid":"doctor_ahmed"},
    {"code":"CS 303", "name":"Advanced Operating System",          "hours":3,"year":3,"term":5,"prereq":None,      "doctor_uid":"doctor_sara"},
    {"code":"CS 304", "name":"Advanced Software Engineering",      "hours":3,"year":3,"term":5,"prereq":None,      "doctor_uid":"doctor_omaima"},
    {"code":"CS 307", "name":"Computer Graphics",                  "hours":3,"year":3,"term":5,"prereq":"CS 310",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 312", "name":"Logic Programming",                  "hours":3,"year":3,"term":5,"prereq":None,      "doctor_uid":"doctor_sara"},
    {"code":"CS 311", "name":"Dynamic Languages",                  "hours":3,"year":3,"term":5,"prereq":"IS 207",  "doctor_uid":"doctor_omaima"},
    {"code":"CS 313", "name":"Cloud Computing",                    "hours":3,"year":3,"term":5,"prereq":"CS 303",  "doctor_uid":"doctor_sara"},

    {"code":"CS 305", "name":"Advanced Computer Networks",         "hours":3,"year":3,"term":6,"prereq":"CS 205",  "doctor_uid":"doctor_omaima"},
    {"code":"CS 306", "name":"Theory & Design of Compilers",       "hours":3,"year":3,"term":6,"prereq":None,      "doctor_uid":"doctor_ahmed"},
    {"code":"CS 308", "name":"Digital Image Processing",           "hours":3,"year":3,"term":6,"prereq":"CS 307",  "doctor_uid":"doctor_sara"},
    {"code":"CS 309", "name":"Microprocessor and Assembly Language","hours":3,"year":3,"term":6,"prereq":"CS 202",  "doctor_uid":"doctor_omaima"},
    {"code":"CS 404", "name":"Distributed Computing",              "hours":3,"year":3,"term":6,"prereq":"CS 303",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 314", "name":"Digital Signal Processing",          "hours":3,"year":3,"term":6,"prereq":"CS 203",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 315", "name":"Mobile App Development",             "hours":3,"year":3,"term":6,"prereq":"IS 207",  "doctor_uid":"doctor_sara"},
    ...
    {"code":"BS 203", "name":"Differential Equations",             "hours":3,"year":4,"term":7,"prereq":"BS 101",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 401", "name":"Artificial Intelligence",            "hours":3,"year":4,"term":7,"prereq":"CS 203",  "doctor_uid":"doctor_sara"},
    {"code":"H 201",  "name":"Quality Assurance & Control",        "hours":3,"year":4,"term":7,"prereq":None,      "doctor_uid":"doctor_omaima"},
    {"code":"CS 402", "name":"Information and Computer Networks Security","hours":3,"year":4,"term":7,"prereq":"CS 305","doctor_uid":"doctor_ahmed"},
    {"code":"CS 403", "name":"Machine Learning",                   "hours":3,"year":4,"term":7,"prereq":"BS 103",  "doctor_uid":"doctor_sara"},
    {"code":"CS 405", "name":"Selected Topics in computer science - level 4","hours":3,"year":4,"term":7,"prereq":None,"doctor_uid":"doctor_omaima"},
    {"code":"CS 406", "name":"Big Data Analysis",                  "hours":3,"year":4,"term":7,"prereq":"IS 206",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 407", "name":"Computer Arabization",               "hours":3,"year":4,"term":7,"prereq":"CS 203",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 408", "name":"Virtual Reality",                    "hours":3,"year":4,"term":7,"prereq":"CS 203",  "doctor_uid":"doctor_sara"},
    {"code":"CS 410", "name":"Internet of Things (IoT)",           "hours":3,"year":4,"term":7,"prereq":"CS 305",  "doctor_uid":"doctor_omaima"},
    {"code":"CS 416", "name":"Knowledge Discovery",                "hours":3,"year":4,"term":7,"prereq":"IS 206",  "doctor_uid":"doctor_sara"},
    {"code":"CS 498", "name":"Graduation Project 1",               "hours":3,"year":4,"term":7,"prereq":None,      "doctor_uid":"doctor_sara"},

    {"code":"CS 302", "name":"Parallel Programming",               "hours":3,"year":4,"term":8,"prereq":"CS 203",  "doctor_uid":"doctor_omaima"},
    {"code":"CS 419", "name":"Deep Learning",                      "hours":3,"year":4,"term":8,"prereq":"CS 403",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 409", "name":"Computer Vision Systems",            "hours":3,"year":4,"term":8,"prereq":"CS 308",  "doctor_uid":"doctor_sara"},
    {"code":"CS 411", "name":"Software Testing and Quality Assurance","hours":3,"year":4,"term":8,"prereq":"CS 304","doctor_uid":"doctor_ahmed"},
    {"code":"CS 412", "name":"Cyber Security",                     "hours":3,"year":4,"term":8,"prereq":"CS 402",  "doctor_uid":"doctor_sara"},
    {"code":"CS 414", "name":"Natural Language Processing",        "hours":3,"year":4,"term":8,"prereq":"CS 403",  "doctor_uid":"doctor_omaima"},
    {"code":"CS 415", "name":"Soft Computing",                     "hours":3,"year":4,"term":8,"prereq":"BS 103",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 417", "name":"Pattern Recognition",                "hours":3,"year":4,"term":8,"prereq":"CS 308",  "doctor_uid":"doctor_omaima"},
    {"code":"CS 418", "name":"Game Programming",                   "hours":3,"year":4,"term":8,"prereq":"CS 307",  "doctor_uid":"doctor_ahmed"},
    {"code":"CS 420", "name":"Data Communications",                "hours":3,"year":4,"term":8,"prereq":"CS 305",  "doctor_uid":"doctor_sara"},
...
STUDENTS = [
    ...
    {"firebase_uid":"doctor_ahmed",  "name":"Dr. Ahmed Kamal","gpa":4.0,"current_year":4,"current_term":2,"password":"doc",  "role":"doctor","warnings":0,"is_suspended":"active"},
    {"firebase_uid":"doctor_sara",   "name":"Dr. Sara Nasser","gpa":4.0,"current_year":4,"current_term":2,"password":"doc",  "role":"doctor","warnings":0,"is_suspended":"active"},
